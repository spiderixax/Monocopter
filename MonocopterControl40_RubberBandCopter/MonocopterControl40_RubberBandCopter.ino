...
float default_angle_rubber = 65;
float servo_angle_rubber = default_angle_rubber;
//float default_angle_wing = 90;
float default_angle_wing = 85;
...
void setup() {
  ...
  ServoRubberBand.attach(rubberBandPin);
  ServoRubberBand.write(default_angle_rubber);
...
*/
  ...
  if (z_vec < -60) {
    servo_angle_rubber = default_angle_rubber - (50 * sin(0.01745329 * (current_bearing - flight_bearing) + 1.570796 + 2.094395));
    if (servo_angle_rubber < default_angle_rubber) {
      ServoRubberBand.write(servo_angle_rubber);
    }
    else {
      ServoRubberBand.write(default_angle_rubber);
    }
