...
// Read in the length of the signal in microseconds
  ...
  if ((x_vec >= 0) && (y_vec >= 0)){
    ...
    if (0 < current_bearing < flight_bearing + 90 or 270 + flight_bearing < current_bearing < 360) {
      flyDirection = true;
    }
    ...
    if (flight_bearing - 45 < current_bearing < flight_bearing + 45) {
      flyDirection = true;
    }
    ...
    if (flight_bearing - 45 < current_bearing < 360 or 0 < current_bearing < 360 - flight_bearing) {
      flyDirection = true;
    }
  ...
  if (flight_magnitude > 25) {
    ...
    if (flyDirection == true) {
      servo_angle = neutral_angle - flap_constant * flight_magnitude;
    }
  ...
  //if ( current_bearing > 230 and current_bearing < 310 ) {
    //digitalWrite(2, HIGH);
  //}
