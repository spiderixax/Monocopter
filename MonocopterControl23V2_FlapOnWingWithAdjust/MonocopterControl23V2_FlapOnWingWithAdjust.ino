...
void loop() {
  ...
  if (flight_magnitude > 40) {
    servo_angle_1 = neutral_angle_1 - (flap_constant * flight_magnitude * 57.29578 * sin(0.01745329 * (current_bearing - flight_bearing) + 4.712389 + 3.141593));
  }
  ...
  if (servoUpdateDifference > 3 or servoUpdateDifference < -3) {
