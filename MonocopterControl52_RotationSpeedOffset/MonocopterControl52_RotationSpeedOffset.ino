...
void loop() {
  ...
  if (flight_magnitude > 40) {
    ...
    motor_power = z - (flap_constant * flight_magnitude * sin(0.01745329 * (current_bearing - flight_bearing) + 4.71239 - (offset_constant * (flight_magnitude / predicted_rotation_time) ) ));
  }
