...
void loop() {
  ...
  if (flight_magnitude > 40) {
    ...
    motor_power = z - (flap_constant * flight_magnitude * sin(0.01745329 * (current_bearing - flight_bearing) + 1.5708 + (rotation_speed_offset / predicted_rotation_time) + (flight_magnitude * flight_magnitude_offset)));
  }
