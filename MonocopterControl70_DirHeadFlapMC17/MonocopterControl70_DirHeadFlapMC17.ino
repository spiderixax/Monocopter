...
int default_angle_wing = 140; //90-somewhat works?, 80-too low, 110-too high, 100-unstable
...
void loop() {
  ...
  current_bearing = compass.readHeading();
  ...
  if (current_bearing >= 112 and current_bearing < 292) {
  ...
  if (flight_magnitude > 40) {
    servo_angle_wing = default_angle_wing - (flap_constant * flight_magnitude * sin(0.01745 * (current_bearing - flight_bearing) + 4.3284));
  }
