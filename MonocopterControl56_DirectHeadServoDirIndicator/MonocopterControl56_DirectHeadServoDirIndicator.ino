...
void loop() {
  ...
  if (flight_magnitude > 50 and sin(0.01745329 * (current_bearing - flight_bearing) + 4.712389) < -0.8) {
    digitalWrite(blueLedWing, HIGH);
    digitalWrite(redLedWing, HIGH);
  }

  else if (flight_magnitude > 50 and sin(0.01745329 * (current_bearing - flight_bearing) + 4.712389) > 0.8) {
